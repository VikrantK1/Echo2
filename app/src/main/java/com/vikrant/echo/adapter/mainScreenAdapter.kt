...
class mainScreenAdapter(songDetail: ArrayList<Songs>, _context: Context) :
    RecyclerView.Adapter<mainScreenAdapter.innerclass>() {
    ...
    override fun onBindViewHolder(holder: innerclass, p1: Int) {
        ...
        holder?.xcontext?.setOnClickListener({
            ...
            args.putInt("Position", p1 as Int)
    ...
    class innerclass(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            xcontext = itemView?.findViewById(R.id.content_row)
        }
    }
}